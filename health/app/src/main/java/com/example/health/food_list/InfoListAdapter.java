...
//返回指定位置对于的数据
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = LayoutInflater.from(context).inflate(R.layout.item_infolist_lv,null);//将布局转换为view对象的方法
    ...
    class ViewHolder{
        ...
        public ViewHolder(View view){
            ...
            titleTv = view.findViewById(R.id.item_info_iv_title);
            notTv = view.findViewById(R.id.item_info_iv_notmatch);
        }
    }
}
